...
WalletSchema.methods.addTransaction = async function(transactionType, amount, description) {
    ...
    const newBalance = transactionType === 'credit' ? parseFloat(this.amount) + parseFloat(amount) : parseFloat(this.amount) - parseFloat(amount);;
